    ...
    <div id="contato" className="isolate px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md border-0 px-3.5 py-2 text shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="w-full  rounded-md btn px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm"
          >
            Enviar
          </button>
        </div>
